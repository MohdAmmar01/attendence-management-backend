...
router.post('/register',async (req,res)=>{
  try{
    if(req.body.username && req.body.email && req.body.password  && req.body.roll){
      ...
      res.status(400).json({"success": false,"message":"user not created ","error":"provide all details"})
    }
